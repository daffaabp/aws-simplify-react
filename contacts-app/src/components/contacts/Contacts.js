...
function Contacts() {
    ...
    const getContacts = async () => {
        try {
            ...
            // Reset profilePicPaths to avoid duplication
            const newProfilePicPaths = [];
            ...
            await Promise.all(contactsList.map(async (contact) => {
                ...
                try {
                    ...
                    newProfilePicPaths.push(contactProfilePicPathURI);
                } catch (err) {
                    console.log('error', err);
                }
            }));

            setProfilePicPaths(newProfilePicPaths);
        } catch (err) {
            console.log('error', err);
        }
    }
